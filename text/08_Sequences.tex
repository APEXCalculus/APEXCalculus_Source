...
\example{ex_seq1}{\textbf{Listing terms of a sequence}\\
...
\example{ex_seq2}{\textbf{Determining a formula for a sequence}\\
...
\example{ex_seq4}{\textbf{Determining convergence/divergence of a sequence}\\
...
\example{ex_seq5}{\textbf{Determining the convergence/divergence of a sequence}\\
Determine the convergence or divergence of the following sequences.
...
\example{ex_seq6}{\textbf{Applying properties of limits of sequences}\\
...
\example{ex_seq3}{\textbf{Determining boundedness of sequences}\\
...
\example{ex_seq7}{\textbf{Determining monotonicity}\\
