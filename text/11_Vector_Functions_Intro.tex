...
\example{ex_vvf1}{\textbf{Graphing vector--valued functions}\\
...
\example{ex_vvf2}{\textbf{Graphing vector--valued functions.}\\
...
\example{ex_vvf3}{\textbf{Adding and scaling vector--valued functions.}\\
...
\example{ex_vvf4}{\textbf{Adding and scaling vector--valued functions.}\\
...
\example{ex_vvf5}{\textbf{Finding and graphing displacement vectors}\\
...
\example{ex_vvf6}{\textbf{Average rate of change}\\
