...
whenever $|x - c| < \delta$, we have $|f(x) - L| < \epsilon$.\index{limit!definition}
}
...
\mfigure{.8}{Choosing $\delta = \epsilon/5$ in Example \ref{ex_compute_lim2}.}{fig:limit_eover5}{figures/figLimitProof2a}
...
\example{ex_compute_lim3}{Evaluating a limit using the definition}{Show that $\displaystyle \lim_{x\rightarrow 0} e^x = 1 $.}
