...
\example{ex_tpl1}{\textbf{Finding directional tangent lines}\\
...
\example{ex_tpl2}{\textbf{Finding directional tangent lines}\\
...
\example{ex_tpl3}{\textbf{Finding a normal line}\\
...
\example{ex_tpl4}{\textbf{Finding the distance from a point to a surface}\\
...
\example{ex_tpl5}{\textbf{Finding a point a set distance from a surface}\\
Let $f(x,y) = x-y^2+3$. Let $P = \big(2,1,f(2,1)\big) = (2,1,4)$. Find points $Q$ in space that is 4 units from the surface of $f$ at $P$. That is, find $Q$ such that $\norm{\vv{PQ}}=4$ and $\vv{PQ}$ is orthogonal to $f$ at $P$.}
...
\example{ex_tpl6}{\textbf{Finding tangent planes}\\
...
\example{ex_tpl7}{\textbf{Using the tangent plane to approximate function values}\\
...
\example{ex_tpl8}{\textbf{Using the gradient to find a tangent plane}\\
