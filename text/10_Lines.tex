...
\example{ex_lines1}{\textbf{Finding the equation of a line}\\
...
\example{ex_lines6}{\textbf{Finding the equation of a line through two points}\\
...
\mfigure{.6}{A graph of the line in Example \ref{ex_lines6}.}{fig:lines6}{figures/figlines6}
...
\example{ex_lines2}{\textbf{Comparing lines}\\
...
\example{ex_lines3}{\textbf{Comparing lines}\\
Consider lines $\ell_1$ and $\ell_2$, given in parametric equation form:
...
\example{ex_lines4}{\textbf{Finding the distance from a point to a line}\\
...
\example{ex_lines5}{\textbf{Finding the distance between lines}\\
