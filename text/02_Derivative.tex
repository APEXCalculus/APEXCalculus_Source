...
\example{ex_der_line}{Finding the Derivative of a Line}{quad Consider $f(x) = 3x+5$. Find the equation of the tangent line to $f$ at $x=1$ and $x=7$.}
...
\example{ex_der_num_approx}{Numerical Approximation of the Tangent Line}{quad Give an approximation to the tangent line of $f(x)=\sin x$ at $x=0$.}
