...
\mtable{.8}{The volume of a general right cylinder}{fig:cross1}{\begin{tikzpicture}[x=13pt,y=10pt,thick]
			\begin{scope}
...
\example{ex_disk0}{\textbf{Finding the volume of a solid}\\
...
\example{ex_disk1}{\textbf{Finding volume using the Disk Method}\\
...
\example{ex_disk2}{\textbf{Finding volume using the Disk Method}\\
...
\example{ex_wash1}{\textbf{Finding volume with the Washer Method}\\
...
\example{ex_wash2}{\textbf{Finding volume with the Washer Method}\\
