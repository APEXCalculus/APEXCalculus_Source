...
\example{ex_num1}{\textbf{Approximating definite integrals with rectangles}\\
...
\example{ex_num2}{\textbf{Approximating definite integrals with rectangles}\\
...
\example{ex_num3}{\textbf{Approximating definite integrals using trapezoids}\\
...
\example{ex_num4}{\textbf{Using the Trapezoidal Rule}\\
...
\example{ex_num5}{\textbf{Using Simpson's Rule}\\
...
\example{ex_num6}{\textbf{Using Simpson's Rule}\\
...
\example{ex_num7}{\textbf{Computing error bounds}\\
...
\example{ex_num8}{\textbf{Approximating distance traveled}\\
