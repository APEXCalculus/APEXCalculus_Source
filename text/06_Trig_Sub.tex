...
\example{ex_trigsub1}{\textbf{Using Trigonometric Substitution}\\
Evaluate $\ds \int_{-3}^3\sqrt{9-x^2}\ dx$.}
{We begin by noting that $9\sin^2\theta + 9\cos^2\theta = 9$, and hence $9\cos^2\theta = 9-9\sin^2\theta$. If we let $x=3\sin\theta$, then $9-x^2 = 9-9\sin^2\theta = \cos^2\theta$. 
...
\begin{align*}
			...
			& = \frac92 \big(\theta +\frac12\sin(2\theta)\big)\Bigg|_{-\pi/2}^{\pi/2}
			%&= \frac92\pi.
\end{align*}
...
\example{ex_trigsub3}{\textbf{Using Trigonometric Substitution}\\
...
\example{ex_trigsub2}{\textbf{Using Trigonometric Substitution}\\
...
\example{ex_trigsub4}{\textbf{Using Trigonometric Substitution}\\
...
\example{ex_trigsub5}{\textbf{Using Trigonometric Substitution}\\
...
\example{ex_trigsub7}{\textbf{Using Trigonometric Substitution}\\
...
\example{ex_trigsub6}{\textbf{Definite integration and Trigonometric Substitution}\\
