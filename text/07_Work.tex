...
\clearpage
\example{ex_work1}{\textbf{Computing work performed: applying variable force}\\
...
\example{ex_work1_5}{\textbf{Computing work performed: applying variable force}\\
...
\example{ex_work2}{\textbf{Computing work performed: applying variable force}\\
...
\mtable{.8}{Weight and Mass densities}{fig:weight_density}{%
\begin{tabular}{ccc}
...
\example{ex_pump1}{\textbf{Computing work performed: pumping fluids}\\
...
\example{ex_pump2}{\textbf{Computing work performed: pumping fluids}\\
...
\example{ex_pump3}{\textbf{Computing work performed: pumping fluids}\\
