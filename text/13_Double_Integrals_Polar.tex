...
\example{ex_doublepol1}{\textbf{Evaluating a double integral with polar coordinates}\\
...
\example{ex_doublepol2}{\textbf{Evaluating a double integral with polar coordinates}\\
...
\example{ex_doublepol5}{\textbf{Evaluating a double integral with polar coordinates}\\
...
{\mfigure[scale=1.2,trim=1mm 0mm 0mm 0mm,clip]{.5}{The surface and region $R$ used in Example \ref{ex_doublepol5}.}{fig:doublepol5}{figures/figdoublepol5}
...
\mnote{.7}{\textbf{Note:} Previous work has shown that there is finite \textit{area} under $\frac{1}{x^2+1}$ over the entire $x$-axis. However, Example \ref{ex_doublepol5} shows that there is infinite \textit{volume} under $\frac{1}{x^2+y^2+1}$ over the entire $x$-$y$ plane.}
}\\

\example{ex_doublepol3}{\textbf{Finding the volume of a sphere}\\
...
\example{ex_doublepol4}{\textbf{Finding the volume of a solid}\\
A sculptor wants to make a solid bronze cast of the solid shown in Figure \ref{fig:doublepol4}, where the base of the solid has boundary, in polar coordinates, $r=\cos\theta$, and the top is defined by the plane $z=1-x+0.1y$. Find the volume of the solid.
\mtable{.5}{Finding the volume of the solid shown here from two perspectives.}{fig:doublepol4}{%
\begin{tabular}{c}
