...
\example{ex_mass1}{\textbf{Finding the mass of a lamina with constant density}\\
...
\example{ex_mass2}{\textbf{Finding the mass of a lamina with variable density}\\
...
\example{ex_mass3}{\textbf{Finding the weight of a lamina with variable density}\\
...
\example{ex_mass4}{\textbf{Finding the center of mass of a discrete linear system}\\
\begin{enumerate}
...
\example{ex_mass5}{\textbf{Finding the center of mass of a discrete planar system}\\
...
\end{align*}
\end{minipage}
\mfigure{.8}{Illustrating the center of mass of a discrete planar system in Example \ref{ex_mass5}.}{fig:mass5}{figures/figmass5}
...
We start our practice of finding centers of mass by revisiting some of the lamina used previously in this section when finding mass. We will mostly just set up the integrals needed to compute $M$, $M_x$ and $M_y$ and leave the details of the integration to the reader.\\

\example{ex_mass6}{\textbf{Finding the center of mass of a lamina}\\
...
\example{ex_mass7}{\textbf{Finding the center of mass of a lamina}\\
...
\example{ex_mass8}{\textbf{Finding the center of mass of a lamina}\\
...
\example{ex_mass9}{\textbf{Finding the center of mass of a lamina}\\
