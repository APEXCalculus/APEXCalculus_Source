...
The topic of \textit{related rates} takes this one step further: knowing the \textit{rate} at which one quantity is changing can determine the rate at which the other changes.\\
...
\example{ex_rr1}{\textbf{Understanding related rates}\\
...
\example{ex_rr2}{\textbf{Finding related rates}\\
...
\example{ex_rr3}{\textbf{Studying related rates}\\
...
\example{ex_rr4}{\textbf{Studying related rates}\\
