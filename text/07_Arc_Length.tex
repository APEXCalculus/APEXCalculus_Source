...
\example{ex_arc1}{\textbf{Finding arc length}\\
...
\example{ex_arc2}{\textbf{Finding arc length}\\
...
\example{ex_arc3}{\textbf{Approximating arc length numerically}\\
...
\mtable{.4}{A table of values of $y=\sqrt{1+\cos^2x}$ to evaluate a definite integral in Example \ref{ex_arc3}.}{fig:arc3}{%
$$\begin{array}{cc}
...
\example{ex_sa1}{\textbf{Finding surface area of a solid of revolution}\\
...
\example{ex_sa2}{\textbf{Finding surface area of a solid of revolution}\\
