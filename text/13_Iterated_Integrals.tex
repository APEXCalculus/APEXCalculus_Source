...
\example{ex_iterated1}{\textbf{Integrating functions of more than one variable}\\
...
\example{ex_iterated2}{\textbf{Integrating functions of more than one variable}\\
...
\example{ex_iterated3}{\textbf{Integrating an integral}\\
...
\example{ex_iterated4}{\textbf{Area of a rectangle}
...
\example{ex_iterated5}{\textbf{Area of a triangle}\\
...
\example{ex_iterated6}{\textbf{Area of a plane region}\\
