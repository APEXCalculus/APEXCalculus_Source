...
\example{ex_trigint1}{\textbf{Integrating powers of sine and cosine}\\
...
\example{ex_trigint2}{\textbf{Integrating powers of sine and cosine}\\
...
\example{ex_trigint3}{\textbf{Integrating powers of sine and cosine}\\
...
\example{ex_trigint4}{\textbf{Integrating products of $\sin(mx)$ and $\cos(nx)$}\\
...
\example{ex_trigint5}{\textbf{Integrating powers of tangent and secant}\\
...
\example{ex_trigint6}{\textbf{Integrating powers of tangent and secant}\\
...
\example{ex_trigint7}{\textbf{Integrating powers of tangent and secant}\\
