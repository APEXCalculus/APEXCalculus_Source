...
\example{ex_surfacearea1}{\textbf{Finding the surface area of a plane over a triangle}\\
...
\example{ex_surfacearea2}{\textbf{The surface area of a sphere.}\\
...
\example{ex_surfacearea3}{\textbf{Finding the surface area of a cone}\\
...
\example{ex_surfacearea4}{\textbf{Finding surface area over a region}\\
