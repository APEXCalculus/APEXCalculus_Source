...
\example{ex_hf1}{\textbf{Exploring properties of hyperbolic functions}\\
...
\example{ex_hf2}{\textbf{Derivatives and integrals of hyperbolic functions}\\
...
\example{ex_hf3}{\parbox{270pt}{\textbf{Derivatives and integrals involving inverse hyperbolic functions}}\\
