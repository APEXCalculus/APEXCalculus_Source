...
\example{ex_diffal1}{\textbf{Finding and using differentials}\\
...
\example{ex_diffal2}{\textbf{Using differentials to approximate a function value}\\
...
\example{ex_diffal3}{\textbf{Finding differentials}\\
...
\example{ex_diffal4}{\textbf{Using differentials to approximate propagated error}\\
