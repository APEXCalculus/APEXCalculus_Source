...
\example{ex_multilimit1}{\textbf{Determining open/closed, bounded/unbounded}\\
...
\example{ex_multilimit2}{\textbf{Determining open/closed, bounded/unbounded}\\
...
\mfigure[scale=1.25]{.35}{\textbf{Illustrating the definition of a limit.} The open disk in the $x$-$y$ plane has radius $\delta$. Let $(x,y)$ be any point in this disk; $f(x,y)$ is within $\epsilon$ of $L$.}{fig:multilimitdef}{figures/figmultilimit_def}
...
\example{ex_multilimit3}{\textbf{Evaluating a limit}\\
...
\example{ex_multilimit4}{\textbf{Showing limits do not exist}\\
\begin{enumerate}
...
\example{ex_multilimit5}{\textbf{Finding a limit}\\
...
\example{ex_multicont1}{\textbf{Continuity of a function of two variables}\\
...
\mfigure[scale=1.25]{.8}{A graph of $f(x,y)$ in Example \ref{ex_multicont1}.}{fig:multicont1}
...
\example{ex_multicont2}{\textbf{Establishing continuity of a function}\\
