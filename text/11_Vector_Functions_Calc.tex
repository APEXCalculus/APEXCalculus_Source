...
\example{ex_vvflimit1}{\textbf{Finding limits of vector--valued functions}\\
...
\example{ex_vvflimit2}{\textbf{Evaluating continuity of vector--valued functions}\\
...
\example{ex_vvflimit3}{\textbf{Derivatives of vector--valued functions}\\
...
\mtable{.5}{Graphing the derivative of a vector--valued function in Example \ref{ex_vvflimit3}.}{fig:vvflimit3}{%
\begin{tabular}{c}
...
\example{ex_vvflimit4}{\textbf{Derivatives of vector--valued functions}\\
...
{We compute $\vrp$ as $\vrp(t) = \la -\sin t, \cos t, 1\ra$. At $t= \pi/2$, we have $\vrp(\pi/2) = \la -1,0,1\ra$. Figure \ref{fig:vvflimit4} shows two graphs of $\vec r(t)$, from different perspectives, with $\vrp(\pi/2)$ plotted with its initial point at the origin and at $\vec r(\pi/2)$.
\begin{center}
	\myincludegraphics[scale=1.25]{figures/figvvflimit4}\myincludegraphics[scale=1.25]{figures/figvvflimit4a} 
...
\example{ex_vvfderiv1}{\textbf{Finding tangent lines to curves in space}\\
...
\mtable{.73}{Graphing a curve in space with its tangent line.}{fig:vvfderiv1}{%
\begin{tabular}{c}
...
\example{ex_vvfderiv3}{\textbf{Finding tangent lines to curves}\\
...
\mfigure{.4}{Graphing $\vec r(t)$ and its tangent line in Example \ref{ex_vvfderiv3}.}{fig:vvfderiv3}{figures/figvvfderiv3}
...
\example{ex_vvfderiv2}{\textbf{Using derivative properties of vector--valued functions}\\
...
\example{ex_vvfint1}{\textbf{Evaluating a definite integral of a vector--valued function}\\
...
\example{ex_vvfint2}{\textbf{Solving an initial value problem}\\
