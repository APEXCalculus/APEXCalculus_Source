...
\example{ex_multi_extreme1}{\textbf{Finding critical points and relative extrema}\\
...
\example{ex_multi_extreme2}{\textbf{Finding critical points and relative extrema}\\
...
\example{ex_multi_extreme3}{\textbf{Finding critical points and relative extrema}\\
...
\example{ex_multi_extreme4}{\textbf{Using the Second Derivative Test}\\
...
\example{ex_multi_extreme5}{\textbf{Using the Second Derivative Test}\\
...
\example{ex_conopt1}{\textbf{Finding extrema on a closed set}\\
...
\example{ex_conopt2}{\textbf{Constrained Optimization}\\
