...
\example{ex_multi1}{\textbf{Understanding a function of two variables}\\
...
\example{ex_multi2}{\textbf{Understanding a function of two variables}\\
...
\example{ex_levelcurve1}{\textbf{Drawing Level Curves}\\
...
\example{ex_levelcurves2}{\textbf{Analyzing Level Curves}\\
...
\example{ex_multi3}{\textbf{Understanding a function of three variables}\\
...
\example{ex_multi4}{\textbf{Finding level surfaces}\\
