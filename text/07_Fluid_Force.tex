...
\example{ex_fluid1}{\textbf{Computing fluid force}%
	\begin{enumerate}
...
\example{ex_fluid2}{\textbf{Finding fluid force}\\
...
\example{ex_fluid3}{\textbf{Finding fluid force}\\
...
\example{ex_fluid4}{\textbf{Finding fluid force}\\
...
F 		&= 62.4\int_{-1.5}^{1.5} 2(50-y)\sqrt{2.25-y^2}\ dy \\
			...
			&= 6240\int_{-1.5}^{1.5} \big(\sqrt{2.25-y^2}\ dy - 62.4\int_{-1.5}^{1.5} 2y\sqrt{2.25-y^2}\big)\ dy \\
\end{align*}			
