...
\example{ex_motion1}{\textbf{Finding velocity and acceleration}\\
...
\example{ex_motion2}{\textbf{Analyzing Motion}\\
...
\example{ex_motion3}{\textbf{Analyzing the motion of a whirling ball on a string}\\
...
\example{ex_motion4}{\textbf{Analyzing motion in space}\\
An object moves in spiral with position function $\vrt = \la \cos t, \sin t, t\ra$, where distances are measured in meters and time is in minutes. Describe the object's speed and acceleration at time $t$.
}
...
\example{ex_motion5}{\textbf{Projectile Motion}\\
...
\example{ex_motion61}{\textbf{Projectile Motion}\\
...
\enlargethispage{2\baselineskip}
\example{ex_motion6}{\textbf{Distance Traveled, Displacement, and Average Speed}\\
