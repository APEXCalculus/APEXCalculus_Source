...
The graph of $f$ is \textbf{concave up} on $I$ if $\fp$ is increasing. The graph of $f$ is \textbf{concave down} on $I$ if $\fp$ is decreasing. If $\fp$ is constant then the graph of $f$ is said to have \textbf{no concavity}.
}
...
\mfigure{.3}{A function $f$ with a concave down graph. Notice how the slopes of the tangent lines, when looking from left to right, are increasing.}{fig:concavity2}{figures/figconcavity2}
...
\example{ex_conc1}{\textbf{Finding intervals of concave up/down, inflection points}\\
...
\example{ex_conc2}{\textbf{Finding intervals of concave up/down, inflection points}\\
...
\example{ex_conc3}{\textbf{Understanding inflection points}\\
...
\mfigure{.55}{A graph of $S(t)$ in Example \ref{ex_conc3}, modeling the sale of a product over time.}{fig:conc3}{figures/figconc3}
}
...
\mfigure{.8}{A graph of $S(t)$ in Example \ref{ex_conc3} along with $S'(t)$ in red.}{fig:conc3b}{figures/figconc3b}
...
\example{ex_conc4}{\textbf{Using the Second Derivative Test}\\
