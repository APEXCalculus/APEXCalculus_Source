...
\example{ex_tannorm1}{\textbf{Computing the unit tangent vector}\\
...
\example{ex_tannorm2}{\textbf{Computing the unit tangent vector}\\
...
\example{ex_tannorm3}{\textbf{Computing the unit normal vector}\\
...
\example{ex_tannorm4}{\textbf{Computing the unit normal vector}\\
...
{Let $\vec r(t)$ be a vector--valued function in $\mathbb{R}^2$ where $\vec T\,'(t)$ is smooth on an open interval $I$. Let $\vec T(t) = \la t_1,t_2\ra$. Then $\vec N(t)$ is either
...
\example{ex_tannorm5}{\textbf{Computing $a_\text{T}$ and $a_\text{N}$}\\
...
\example{ex_tannorm6}{\textbf{Computing $a_\text{T}$ and $a_\text{N}$}\\
...
\example{ex_tannorm7}{\textbf{Analyzing projectile motion}\\
A ball is thrown from a height of 240ft with an initial velocity of 64ft/s with an angle of elevation of $30^\circ$. Find the position function \vrt\ for the ball and analyze $a_\text{T}$ and $a_\text{N}$.
}
