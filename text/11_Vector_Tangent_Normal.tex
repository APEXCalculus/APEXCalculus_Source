...
A ball is thrown from a height of 240ft with an initial velocity of 64ft/s with an angle of elevation of $30^\circ$. Find the position function \vrt\ for the ball and analyze $a_\text{T}$ and $a_\text{N}$.\index{projectile motion}
}
