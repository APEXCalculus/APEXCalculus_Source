...
surface s=surface(f,(-5,-6),(5,6),4,4,Spline);
pen p=rgb(0,0,.7)+.1mm;
...
draw((5,6,6)--(-5,1,-4),rgb(.1,.1,.1)+.7mm);label("$\ell_1$",(5,6,6),N);//L1
draw((5,-1,2)--(-4.9,5.6,-1.3),rgb(.1,.1,.1)+.7mm);label("$\ell_2$",(5,-1,2),N);//L2
