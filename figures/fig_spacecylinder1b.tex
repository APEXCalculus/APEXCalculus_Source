...
\addplot3[domain=0:360,smooth,y domain=-1.5:1.3,surf,%fill=white,
colormap={mp2}{\colormapplaneone},faceted color=black!40,samples=30,very thin,z buffer=sort] ({cos(x)},{sin(x)},{y});

\addplot3[domain=-40:130,,thick,smooth,samples y=0,{\colorone},%surf,%fill=white,
samples=30,] ({cos(x)},{sin(x)},{0});
\addplot3[domain=130:320,,thick,dashed,smooth,samples y=0,{\colorone},%surf,%fill=white,
samples=30,] ({cos(x)},{sin(x)},{0});

\addplot3[domain=-40:130,,thick,smooth,samples y=0,{\colorone},%surf,%fill=white,
samples=30,] ({cos(x)},{sin(x)},{-1.5});
\addplot3[domain=130:320,dashed,thick,smooth,samples y=0,{\colorone},%surf,%fill=white,
samples=30,] ({cos(x)},{sin(x)},{-1.5});
