...
\addplot [{\colorone},smooth,thick,domain=0:360] ({sqrt(2)*cos(x)},{sqrt(2)/2*sin(x)});
\addplot [{\colorone},smooth,thick,domain=0:360] ({sqrt(3)*cos(x)},{sqrt(3)/2*sin(x)});
\addplot [{\colorone},smooth,thick,domain=0:360] ({sqrt(4)*cos(x)},{sqrt(4)/2*sin(x)});
