...
//path3 mypath=graph(g,-1,-0.9,operator ..); draw(mypath,rgb(.1,.1,.1),Arrow3(size=4mm));
path3 mypath=graph(g,-1,-0.7,operator ..); draw(mypath,rgb(.1,.1,.1),Arrow3(size=4mm));
//path3 mypath=graph(g,-1,0.7,operator ..); draw(mypath,rgb(.1,.1,.1),Arrow3(size=4mm));
//path3 mypath=graph(g,-1,0.9,operator ..); draw(mypath,rgb(.1,.1,.1),Arrow3(size=4mm));
...
dotfactor=4;
dot(((0.189,(0.189)^2,2*(0.189)^3)),rgb(.3,.3,.3));
dot(((-0.189,(-0.189)^2,2*(-0.189)^3)),rgb(.3,.3,.3));
