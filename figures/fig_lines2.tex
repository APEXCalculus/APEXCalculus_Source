...
\addplot3[domain=-2.5:3.5,thick,samples y=0,{\colorone}] ({1+3*x},{2-x},{x});

\addplot3[domain=-2.5:3.5,thick,samples y=0,{\colorone}] ({-2+4*x},{3+x},{5+2*x});

\draw (axis cs:-1,6,5.8) node [below] {\scriptsize $\ell_2$};

\filldraw [black] (axis cs:-2,3,5) circle (1.5pt) node [above] {\scriptsize $P_2$};

\draw [->,thick,black] (axis cs:-2,3,5) -- (axis cs: 2,4,7) node [black,below] {\scriptsize $\vec d_2$};

\draw (axis cs:2.7,-4,0) node [below] {\scriptsize $\ell_1$};

\filldraw [black] (axis cs:1,2,0) circle (1.5pt) node [below] {\scriptsize $P_1$};

\draw [->,thick,black] (axis cs:1,2,0) -- (axis cs: 4,1,1) node [black,below] {\scriptsize $\vec d_1$};
%
