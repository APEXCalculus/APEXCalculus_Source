...
//draw((-5,5,-2)--(7,-1,4),rgb(.1,.1,.1));//L1  t=-3 to t=3
//draw((-9,-3,9)--(15,9,-3),rgb(.1,.1,.1));//L2  t=-3 to t=3
draw((-1,3,0)--(9,-2,5),rgb(.1,.1,.1));//L1  t=-1 to t=4
draw((-1,1,5)--(19,11,-5),rgb(.1,.1,.1));//L2  t=-1 to t=4
...
draw((5,0,3)--(7,-1,4),rgb(.3,.3,.3)+linewidth(2),Arrow3(size=3mm));label("$\vec{d_1}$",(7,-1,4),N);//d1
draw((11,7,-1)--(15,9,-3),rgb(.3,.3,.3)+linewidth(2),Arrow3(size=3mm));label("$\vec{d_2}$",(15,9,-3),N);//d2
...
draw((2.5,1.25,1.75)--(2.45,1.975,2.525),rgb(.3,.3,.3)+linewidth(2),Arrow3(size=3mm));// c
