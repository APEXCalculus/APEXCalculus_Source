...
\addplot3[domain=-1:4,y domain=-1:3,surf,colormap={mp2}{\colormapplaneone},shader=faceted,faceted color=black!40,samples y=15,very thin,z buffer=sort,%opacity=.6,
samples=15,] (x,y,{20-x^2-2*y^2});

\addplot3 [thick,{\colorone}, smooth,domain=1:4,samples=20,samples y=0] ({x},{x^2/4},{20-x^2-0.125*x^4});
%%

%\addplot3 [thick,{\colortwo}, smooth,domain=.5:4,samples=20,samples y=0] ({x},{x^2},{20-x^2-2*x^4});
%
%\addplot3 [thick,{\colortwo}, smooth,domain=.5:4,samples=20,samples y=0] ({x},{2*x^2},{20-x^2-8*x^4});
