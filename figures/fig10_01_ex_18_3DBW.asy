...
path3 mypath=graph(g,-3,3,operator ..); draw(mypath,rgb(.3,.3,.3));
triple g(real t) {return (-1,-1,t);}
path3 mypath=graph(g,-3,3,operator ..); draw(mypath,rgb(.3,.3,.3));
...
path3 mypath=graph(g,.1,10,operator ..); draw(mypath,rgb(.1,.1,.1));
triple g(real t) {return (t,1/t,0);}
path3 mypath=graph(g,-10,-.1,operator ..); draw(mypath,rgb(.1,.1,.1));
