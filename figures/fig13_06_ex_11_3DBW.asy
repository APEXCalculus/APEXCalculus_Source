...
//edges of object
draw((0,1,0)--(2,1,0)--(2,0,0)--cycle,rgb(.1,.1,.1)+linewidth(2));
draw((0,1,0)--(2,1,4)--(2,1,0)--cycle,rgb(.1,.1,.1)+linewidth(2));
draw((0,1,0)--(2,1,4)--(2,0,0)--cycle,rgb(.1,.1,.1)+linewidth(2));
