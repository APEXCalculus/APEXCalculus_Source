...
draw(surface(p1 -- (1,0,0)--(0,0,0)--cycle), emissive(simplesurfacepen+opacity(0.2)));
...
draw(surface(p2),emissive(simplesurfacepen+opacity(0.5)));
draw(p2,rgb(.3,.3,.3)+.4mm);

label("$\displaystyle y=\frac{1}{1+x^2}$",(.75,1,0));
