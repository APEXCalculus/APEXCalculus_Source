...
\addplot3[domain=-2.5:2.5,,samples y=0,{\colorone}] ({1+2*x},{-1+3*x},{1+x});

\filldraw [black] (axis cs:1,1,3) circle (1.5pt) node [above] {\scriptsize $Q$};

\draw [->,very thick,black] (axis cs:1,-1,1) -- (axis cs: 3,2,2) node [black,shift={(-10pt,0pt)}] {\scriptsize $\vec d$};
