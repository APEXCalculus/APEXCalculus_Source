...
\addplot [{\colortwo},smooth] coordinates {(0,0.5469)(0.2,0.6536)(0.4,0.7551)(0.6,0.8518)(0.8,0.944)(1.,1.032)(1.
...
\draw (axis cs:8.,1) node {\begin{tikzpicture}
						...
						\draw[{\colortwo}] (0,-10pt)--(10pt,-10pt) node [right,black] {\scriptsize $y= p_4(x)$};
													\end{tikzpicture}};
