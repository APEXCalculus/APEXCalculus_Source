...
//edges of object
draw((0,0,0)--(0,9,0)--(3,9,0)--cycle,rgb(.1,.1,.1)+linewidth(2));
draw((0,9,0)--(0,9,9)--(0,0,0)--cycle,rgb(.1,.1,.1)+linewidth(2));
triple g(real t) {return (t,9,sqrt(81-9*t^2));}
path3 mypath=graph(g,0,3,operator ..);draw(mypath,rgb(.1,.1,.1)+linewidth(2));
...
pen p=rgb(0,0,.7)+.1mm;
draw(s,emissive(simplesurfacepen),meshpen=p);
