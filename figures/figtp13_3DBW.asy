...
//ASY file for figtp133D.asy in Chapter 12
...
surface s=surface(f,(-0.25,-0.25),(1.75,1.75),16,16,Spline);
pen p=rgb(0,0,.7);
...
//Draw the line (0,1,1)+t(0,-2,-1) for t=-1,1
draw((0,3,2)--(0,-1,0),rgb(.3,.3,.3));
