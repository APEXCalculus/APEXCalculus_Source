...
\draw [thick,{\colortwo},->] (axis cs:2,1) -- (axis cs:5,1) node [black,above] {\scriptsize $\vec v(\pi/4)$};

\draw [thick,{\colortwo},->] (axis cs: 2,1) -- (axis cs:4,-1) node [black,below] {\scriptsize $\vec a(\pi/4)$};
