...
//edges of object
draw((1,0,0)--(1,2,0)--(3,2,0)--(3,0,0)--cycle,rgb(.1,.1,.1)+linewidth(2));
draw((3,0,0)--(1,0,1)--(1,2,1)--(3,2,0),rgb(.1,.1,.1)+linewidth(2));
draw((3,0,0)--(1,0,1),rgb(.1,.1,.1)+linewidth(2));
draw((1,0,0)--(1,0,1),rgb(.1,.1,.1)+linewidth(2));
draw((1,2,0)--(1,2,1),rgb(.1,.1,.1)+linewidth(2));
