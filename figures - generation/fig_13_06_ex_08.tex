...
\draw [{\coloronefill}, very thin,fill={\coloronefill},opacity=.6] (axis cs: 3,0,0) -- (axis cs: 3,2,0) -- (axis cs: 1,2,1) -- (axis cs: 1,0,1)--  cycle;

\draw [{\colorone}, very thick] (axis cs: 3,0,0) -- (axis cs: 3,2,0) -- (axis cs: 1,2,1) -- (axis cs: 1,0,1)--  cycle;

\draw [->] (axis cs: 0,2,1) node [above] {\scriptsize $z= \frac12(3-x)$} -- (axis cs: 1,.5,.5);
