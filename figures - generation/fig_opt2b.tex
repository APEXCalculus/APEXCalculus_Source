...
\draw [shift = {(150pt,0)}] (0,0) -- (0,50pt) -- (80pt,50pt) node [pos=.5,below] {$x$} --(80pt,0) node [pos=.5,right] {$y$};
\draw [{\colorone},very thick,shift = {(150pt,0)}] (0,0) sin (40pt,2pt) cos (80pt,0);
